...
A total of `r nrow(dataset)` people from the Intergroup Relations Lab, SAM Lab, SPRQL, and other Joel Affiliates came together to triangulate the predominant thoughts and feelings about Joel.

This survey was not REB-approved, but all participants gave their consent prior to participation.

.pull-left[
<br><br><br>
.black[Participants were compensated for their time with a photo of a true supermodel, Lily (pictured). 
<br><br><br><br><br><br> 
...
<br>
With our flawless sampling, measurement, and design, we draw your attention to several key take-aways:   
- Joel’s amazingness and wonderfulness cannot be measured with a 6-point Likert scale, and we were fools to think it could be.    
- We suggest a new life goal for Joel over his next year of life: Master the Italian language with a flawless Sicilian accent.    
- The Joel Affiliates wish Joel happy birthday one hundred trillion, two billion, one hundred fifty million, five hundred forty eight thousand, two hundred ninety five times. If it takes one second to say *happy birthday* once, it would take nearly 3169 millennia to properly deliver on these birthday wishes. This makes sense though, because `r round((length(which(dataset$joel_conspiracy == 1)) / nrow(dataset))*100)`% of Joel Affiliates endorsed the conspiracy that Joel is actually immortal.   
- Although more people gave Joel (compared to the goose) the edge in the Joel vs. Goose showdown, `r round((length(which(dataset$joel_goose == 2)) / nrow(dataset))*100)`% of Joel Affiliates needed more information about the goose to answer the question. Future research must explore what specific goose-related information might drive this decision, and also why are geese so scary?     
- Joel is a very important part of many Joel Affiliates’ lives and (much like we describe Joel), we hope his birthday is remarkable, phenomenal, and sooooooooawesome!      
